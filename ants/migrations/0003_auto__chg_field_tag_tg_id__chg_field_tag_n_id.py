...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'tag.tg_id'
        db.alter_column('ants_tag', 'tg_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ants.tag_list'], null=True))

        # Changing field 'tag.n_id'
        db.alter_column('ants_tag', 'n_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ants.new'], null=True))
    def backwards(self, orm):

        # Changing field 'tag.tg_id'
        db.alter_column('ants_tag', 'tg_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ants.tag_list']))

        # Changing field 'tag.n_id'
        db.alter_column('ants_tag', 'n_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ants.new']))
    models = {
        'ants.comment': {
