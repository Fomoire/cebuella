...
var DateTimeShortcuts = {
	...
	clock_link.appendChild(document.createTextNode(gettext('Clock')));
        // quickElement('img', clock_link, '', 'src', DateTimeShortcuts.media_prefix + 'img/icon_clock.gif', 'alt', gettext('Clock'));
        ...
        quickElement("a", quickElement("li", time_list, ""), gettext("09:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '09:00:00');")
        quickElement("a", quickElement("li", time_list, ""), gettext("12:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '12:00:00');")
        quickElement("a", quickElement("li", time_list, ""), gettext("15:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", '15:00:00');")
	...
	cal_link.appendChild(document.createTextNode(gettext('Calendar')));
        // quickElement('img', cal_link, '', 'src', DateTimeShortcuts.media_prefix + 'img/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
